        ...
        medical_terms = [
            {
                ...
                "definition": "Placeholder definition of medical device" if include_definitions else None,
            ...
            },
            {
                ...
                "definition": "Placeholder definition of symptom" if include_definitions else None,
...
async def get_medical_categories():
    ...
    """
    categories = [
        {"code": "device", "name": "Medical Device", "description": "Medical devices and equipment"},
        {"code": "symptom", "name": "Symptom", "description": "Patient symptoms and conditions"},
        {"code": "diagnosis", "name": "Diagnosis", "description": "Medical diagnoses and conditions"},
        {"code": "treatment", "name": "Treatment", "description": "Medical treatments and procedures"},
        {"code": "medication", "name": "Medication", "description": "Drugs and medications"},
        {"code": "anatomy", "name": "Anatomy", "description": "Body parts and anatomical structures"},
        {"code": "manufacturer", "name": "Manufacturer", "description": "Medical device manufacturers"},
        {"code": "adverse_event", "name": "Adverse Event", "description": "Adverse events and complications"}
    ]
...
async def get_medical_term_definition(term: str, language: Optional[str] = "en"):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Medical term lookup failed"
        )
...
async def validate_medical_terms(terms: List[str], language: Optional[str] = "en"):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Medical term validation failed"
        )
...
async def normalize_medical_terms(terms: List[str], language: Optional[str] = "en"):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Medical term normalization failed"
        )
...
async def get_medical_term_statistics():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Medical term statistics failed"
        ) 