...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "rakshaayan"),
        "USER": os.getenv("POSTGRES_USER", "rakshaayan"),
...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", "samhita2004sam@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", "weqy yrmd hvfi uzvb")
